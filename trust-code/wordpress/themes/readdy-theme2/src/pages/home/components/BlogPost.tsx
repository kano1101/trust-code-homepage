      ...
      <div className="p-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            <div className={`w-12 h-12 bg-gradient-to-br ${siteConfig.theme.gradients.card} rounded-full flex items-center justify-center`}>
              <span className="text-white font-bold text-lg">{siteConfig.author.avatar}</span>
            </div>
            <div>
        ...
        <div className="mt-8 pt-6 border-t border-purple-100">
          <div className="flex items-center justify-between">
            ...
            <button className={`flex items-center space-x-2 bg-gradient-to-r ${siteConfig.theme.gradients.button} text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all cursor-pointer whitespace-nowrap`}>
