  ...
  useEffect(() => {
    ...
    fetch(`/wp-json/wp/v2/tags/${tagId}`)
      ...
      .then(data => {
        ...
        document.title = `タグ: ${data.name} - Trust Code`;
      });
  }, [tagId]);

  const { posts, loading, error } = useWordPressPosts(10, undefined, tagId);
    ...
    <main className="max-w-7xl mx-auto px-4 py-12">
      {tagName && (
        <div className="mb-8">
          ...
          <p className="text-purple-600">このタグの記事一覧</p>
        </div>
      )}
        ...
        <div className="lg:col-span-2">
          ...
          {!loading && !error && posts.length === 0 && (
            <div className="bg-purple-50 border border-purple-200 text-purple-700 px-4 py-8 rounded-lg text-center">
              ...
              <p className="font-medium">このタグに記事がありません</p>
            </div>
          )}
